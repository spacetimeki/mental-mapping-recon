...
This document contains structured notes from a conceptual (previously tested with real-life targets) recon using Nmap and Amass. The goal is to understand how to visualize and interpret network structures, ports, and subdomains in a safe, controlled environment.
