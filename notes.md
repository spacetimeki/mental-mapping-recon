...
This document contains structured notes from a conceptual (inspired by real life events) lab using Nmap and Amass. The goal is to understand how to visualize and interpret network structures, ports, and subdomains in a safe, controlled environment.
